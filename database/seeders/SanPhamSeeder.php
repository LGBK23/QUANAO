...
class SanPhamSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $sanPham = new SanPham();
        $sanPham->ten = 'MLB - Áo thun unisex tay ngắn in hình dễ thương';
        ...
        $sanPham = new SanPham();
        $sanPham->ten = 'MLB - Áo thun unisex cổ tròn tay ngắn phom suông thời trang';
        $sanPham->gia_nhap = 1000000;
        $sanPham->gia_ban = 1790000;
        ...
        $sanPham = new SanPham();
        $sanPham->ten = 'MLB - Áo polo nam tay ngắn Partial Monogram Collar';
        ...
        $sanPham = new SanPham();
        $sanPham->ten = 'MLB - Áo sơ mi denim unisex cổ bẻ tay dài Basic Multi Mega Logo';
        ...
        $sanPham = new SanPham();
        $sanPham->ten = 'MLB - Áo bóng chày unisex tay ngắn Sunny Beach Graphic';
        $sanPham->gia_nhap = 2000000;
        ...
        $sanPham = new SanPham();
        $sanPham->ten = 'MLB - Áo hoodie unisex tay dài phối mũ Basic Mega Logo Overfit Brushed';
        ...
        $sanPham = new SanPham();
        $sanPham->ten = 'MLB - Quần jogger unisex lưng thun Basic Medium Logo Woven Summer';
        $sanPham->gia_nhap = 2000000;
        ...
        $sanPham = new SanPham();
        $sanPham->ten = 'MLB - Quần shorts unisex ống rộng Paisley Clipped Logo Part 3';
        $sanPham->gia_nhap = 1000000;
        $sanPham->gia_ban = 1790000;
        $sanPham->so_luong = 1500;
        $sanPham->loai_id = 7;
